...
class AdminSharePostList extends StatefulWidget {
  @override
  _AdminSharePostListState createState() => _AdminSharePostListState();
}

class _AdminSharePostListState extends State<AdminSharePostList> {
                ...
                onTap: () {
                  showDialog(
                    ...
                    builder: (ctx) => AlertDialog(
                      ...
                      content: Text(
                          'Do you want to share post \'${subitems[i].title}\' to \'${group.name}?\''),
                      actions: <Widget>[
                        FlatButton(
                          child: Text('No'),
                          onPressed: () {
